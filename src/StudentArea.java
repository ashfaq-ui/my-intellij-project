...
public class StudentArea {
    ...
    public static void idVerificationForStudent() {
        boolean loopNeed = true;
        while (loopNeed) {
            System.out.println("1 - Add new Student\n" +
                    "2 - Remove a Student\n" +
                    "3 - check the password for Student\n" +
                    "4 - change the password\n" +
                    "5 - full Student id and password.\n" +
            ...
            try {
                ...
                switch (optionIdVerificationForStudent) {
                    ...
                    case 5:
                        loopNeed = false;
                        popUpTheTextFileForStudentDetails();
                        idVerificationForStudent();
                        break;
    ...
    public static void removeStudent() {
        try {
            ...
            System.out.println("Can you enter the Student id? (for remove)");
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (id.equals(removeId)){
                    if (line.contains(removeId)) {
                        idExists = true ;
                        System.out.println("\nStudent id removed successfully. ID: " + removeId + "\n");
    ...
    public static void checkPassword() {
        try {
            ...
            System.out.print("Can you enter the Student id? (for get the password): ");
            ...
            while ((line = br.readLine()) != null) {
                if (line.contains(checkIdsPassword)) {
                    String[] parts = line.split(",");
                    if (parts.length >= 2) {
                        System.out.println("\n" + "Id: " + checkIdsPassword + "  Password : " + parts[1] + "\n");
                        found = true;
                    }
                }
            }
    ...
    public static void changePassword() {
        ...
        System.out.print("Enter Student ID (for Change the Password): ");
        ask_id = input.next();
    ...
    public static void popUpTheTextFileForStudentDetails() {
        File file = new File("StudentDetails.txt");
